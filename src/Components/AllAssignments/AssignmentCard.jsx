...
const AssignmentCard = ({ assignment }) => {
  ...
  return (
    <div className="card bg-base-100 shadow-xl border-accent border" data-aos="flip-right">
      ...
      <div className="card-body">
        ...
        <div className="card-actions flex justify-center">
          ...
          <Link to={`/update/${_id}`}><button className="btn btn-accent btn-outline">Update</button></Link>
        </div>
      </div>
    </div>
  );
